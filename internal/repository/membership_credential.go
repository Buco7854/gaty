...
type MembershipCredentialRepository interface {
	...
	ListByMembershipAndType(ctx context.Context, membershipID uuid.UUID, credType model.CredentialType, p model.PaginationParams) ([]*model.MembershipCredential, int, error)
